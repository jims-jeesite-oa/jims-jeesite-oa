...
<div id="main">
    <div id="header" class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            ...
            <ul id="userControl" class="nav pull-right">
                <li id=""><a href="#">${fns:getDate('yyyy年MM月d日')}&nbsp;&nbsp;${fns:getWeek()}</a></li>
                <%--<li id="mianPage"><a href="${ctx}/sys/main/form" target="mainFrame" title="首页"><i class="icon-home"></i></a></li>--%>
                <li id="themeSwitch" class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" title="主题切换"><i class="icon-reorder"></i></a>
    ...
    <div id="menu">
        <div id="userLogo">
            ...
            <img src="${user.photo}" class="img-circle" onclick="toHome()">
    ...
    <div>
        ...
        <div id="right">
            <iframe id="mainFrame" name="mainFrame" src="" style="" scrolling="yes" frameborder="yes"
                    width="100%"></iframe>
        </div>
    </div>
</div>
<div id="myModal" class="modal hide fade modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
